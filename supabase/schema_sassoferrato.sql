...
VALUES
  (1, 'Tinkering', '#3db3e4', '2026-07-24', '17:30', '22:00',
   'Discesa libera', 'Si freni chi può', '8+', 'Piazza Bartolo', 20, FALSE, NULL, NULL,
  ...
  (2, 'Matematica', '#46b25e', '2026-07-24', '17:30', '22:00',
   'Labirinti matematici', 'Riuscirai a trovare l''uscita?', '6+', 'Corso Cavour', 20, FALSE, NULL, NULL,
  ...
  (4, 'Natura · VR', '#16b39a', '2026-07-24', '17:30', '21:45',
   'La natura a 360°', 'Le aree naturalistiche delle Marche nei visori VR', '8+', 'Corso Cavour', NULL, TRUE, 45, 20,
